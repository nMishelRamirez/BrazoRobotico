...
classdef Brick < handle
    ...
    methods
        ...
        function tacho = outputGetCount(brick,layer,nos)
            ...
            %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
            % This part of the code solves a bug that the original
            % library contained. The brick ports are identified by the variable
            % nos in the following way: Port A = 0, Port B = 1, Port C = 2,
            % Port D = 3. The variable nos identified well Ports A and B,
            % whereas Ports C and D were indentified incorrectly with the numbers
            % 4 and 8. The following if-sentences correct this bug.
            if nos == 4
                nos = 3;
            elseif nos == 8
                nos = 4;
